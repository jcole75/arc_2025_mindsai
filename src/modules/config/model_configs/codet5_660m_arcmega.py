...
from .codet5_660m import DEFAULT_ACTIVE as BASE_DEFAULT_ACTIVE
from .codet5_660m import MODEL_CONFIG as BASE_MODEL_CONFIG
from .codet5_660m import MODEL_PATH as BASE_MODEL_PATH
